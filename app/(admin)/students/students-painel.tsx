...
import { deleteUser, getAllUsers, LoginResponse } from "@/services/api";
import { useFocusEffect, useRouter } from "expo-router";
import React, { useCallback, useMemo, useState } from "react";
import { ActivityIndicator, Alert, FlatList, Pressable, StyleSheet, Text, TextInput, View } from "react-native";

export default function StudentsPainelScreen() {
    ...
    const load = useCallback(async () => {
        try {
            ...
            Alert.alert("Erro", error.message || "Falha ao carregar estudantes");
        } finally {
            setLoading(false);
        }
    }, []);
    ...
    async function handleDelete(id: string) {
        Alert.alert("Confirmar", "Tem certeza que deseja excluir este estudante?", [
        ...
        <Screen>
            <View style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.h1}>Gerenciar Estudantes</Text>
                </View>
